  ...
  const testimonials = [
    {
      ...
      role: "Web Developer",
      feedback:
        "This website is truly amazing! The UI is clean, and the features are just perfect for my needs.",
    ...
    },
    {
      ...
      feedback:
        "The experience has been seamless. It's user-friendly and the overall design is elegant.",
    ...
    },
    {
      ...
      role: "Content Writer",
      feedback:
        "Loved it! It has made my work so much easier and the support is excellent.",
    ...
    <div className="py-12 mt-20 px-6 md:px-12 lg:px-24">
      ...
      <div className="flex flex-wrap justify-center gap-8">
        {testimonials.map((testimonial) => (
          <div key={testimonial.id} className="w-full md:w-1/2 lg:w-1/3 p-4">
            <div className="bg-white rounded-lg shadow-lg p-6 text-center transition-transform transform hover:scale-105 duration-300 ease-in-out">
              ...
              <p className="mt-4 text-gray-700 italic mb-6">
